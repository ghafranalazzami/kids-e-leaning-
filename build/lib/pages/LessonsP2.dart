...
class LessonsP2 extends StatelessWidget {
  const LessonsP2({
    super.key,
  });
                                          ...
                                          children: [
                                            ErrorBoundary(
                                              ...
                                              builder: (BuildContext context,
                                                ...
                                                child: Text(
                                                  "Hear the sound and match it to the letter",
                                    ...
                                    child: LayoutBuilder(
                                      builder:
                                        ...
                                        children: [
                                          //Group
                                          Positioned(
                                            left: 1.9025413990020752,
                                            top: 44.71875,
                                            child: ErrorBoundary(
                                                child: SvgPicture.network(
                                              "https://mabel-cdn.platui.com/api/v1/transform/s3?projectId=b97a94f5-16d3-44a9-8b46-7410126acfc7&imageHash=66225771368.svg",
                                              height: 41.4298210144043,
                                              width: 44.20709991455078,
                                            )),
                                          )
                                        ],
                                      ),
                            ...
                            ErrorBoundary(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(
                                      'https://mabel-cdn.platui.com/api/v1/transform/s3?projectId=b97a94f5-16d3-44a9-8b46-7410126acfc7&imageHash=713bc3954d1ec7586c8a2b024597f7f2831adc80'),
                                ),
                              ),
                              height: 60.0,
                            ))
                            ...
                            ErrorBoundary(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(
                                      'https://mabel-cdn.platui.com/api/v1/transform/s3?projectId=b97a94f5-16d3-44a9-8b46-7410126acfc7&imageHash=85ccbafffd3fe3a63407a52841d22765ec3d13f0'),
                                ),
                              ),
                            ))
                          ],
                          ...
                          children: [
                            ErrorBoundary(
                              ...
                              decoration: BoxDecoration(
                                image: DecorationImage(
                                  image: NetworkImage(
                                      'https://mabel-cdn.platui.com/api/v1/transform/s3?projectId=b97a94f5-16d3-44a9-8b46-7410126acfc7&imageHash=f33269eef3eaa9097750a74704ad5ab1a1f6f4e1'),
                                  fit: BoxFit.cover,
                                ),
                              ),
                            ))
